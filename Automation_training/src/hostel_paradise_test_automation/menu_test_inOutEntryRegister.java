...
public class menu_test_inOutEntryRegister extends utility{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//body/div[1]/aside[1]/div[2]/nav[1]/ul[1]/li[4]/ul[1]/li[2]/a[1]")).click();
		
		Thread.sleep(2000); // 1000 Milliseconds = 1 sec
		
		String inOutEntryRegisterUrl = driver.getCurrentUrl();
		System.out.println(inOutEntryRegisterUrl);
		
		if(inOutEntryRegisterUrl.contains("register_inout")) {
			System.out.println("In Out Entry Register Menu is visible and test case is passsed");
		}
		else {
