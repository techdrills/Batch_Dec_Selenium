...
public class menu_test_inOutEntry extends utility {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String inOutEntryUrl = driver.getCurrentUrl();
		System.out.println(inOutEntryUrl);
		
		if(inOutEntryUrl.contains("in_out")) {
			System.out.println("In Out Entry Menu is visible and test case is passsed");
		}
		else {
